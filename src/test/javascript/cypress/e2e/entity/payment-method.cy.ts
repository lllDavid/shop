...
describe('PaymentMethod e2e test', () => {
  ...
  describe('PaymentMethod page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('edit button click should load edit PaymentMethod page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('PaymentMethod');
  ...
  describe('new PaymentMethod page', () => {
    ...
    it('should create an instance of PaymentMethod', () => {
      cy.get(`[data-cy="name"]`).type('nearly knowingly');
      cy.get(`[data-cy="name"]`).should('have.value', 'nearly knowingly');

      cy.get(`[data-cy="description"]`).type('decode wherever wisely');
      cy.get(`[data-cy="description"]`).should('have.value', 'decode wherever wisely');
