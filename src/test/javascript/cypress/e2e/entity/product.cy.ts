...
describe('Product e2e test', () => {
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('upwardly until nervously');
      cy.get(`[data-cy="name"]`).should('have.value', 'upwardly until nervously');

      cy.get(`[data-cy="description"]`).type('recklessly germinate whether');
      cy.get(`[data-cy="description"]`).should('have.value', 'recklessly germinate whether');

      cy.get(`[data-cy="price"]`).type('29114.45');
      cy.get(`[data-cy="price"]`).should('have.value', '29114.45');

      cy.get(`[data-cy="inStock"]`).type('15598');
      cy.get(`[data-cy="inStock"]`).should('have.value', '15598');
