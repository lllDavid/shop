...
describe('Customer e2e test', () => {
  ...
  describe('new Customer page', () => {
    ...
    it('should create an instance of Customer', () => {
      cy.get(`[data-cy="lastName"]`).type('Hackett');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Hackett');

      cy.get(`[data-cy="firstName"]`).type('Joelle');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Joelle');

      cy.get(`[data-cy="address"]`).type('excepting faithfully');
      cy.get(`[data-cy="address"]`).should('have.value', 'excepting faithfully');

      cy.get(`[data-cy="email"]`).type('Willard.Medhurst82@hotmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Willard.Medhurst82@hotmail.com');

      cy.get(`[data-cy="password"]`).type('brr');
      cy.get(`[data-cy="password"]`).should('have.value', 'brr');
