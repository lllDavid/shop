...
describe('Category e2e test', () => {
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      cy.get(`[data-cy="name"]`).type('contaminate fault');
      cy.get(`[data-cy="name"]`).should('have.value', 'contaminate fault');

      cy.get(`[data-cy="description"]`).type('adored');
      cy.get(`[data-cy="description"]`).should('have.value', 'adored');
