...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.PaymentMethod} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.PaymentMethodResource} to receive all the possible filtering options from
...
public class PaymentMethodCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, ordersId, distinct);
    }
