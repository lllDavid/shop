...
export class ProductFormService {
  createProductFormGroup(product: ProductFormGroupInput = { id: null }): ProductFormGroup {
    ...
    return new FormGroup<ProductFormGroupContent>({
      ...
      name: new FormControl(productRawValue.name,[Validators.required,Validators.pattern('[a-zA-Z_-\\s]*')]),  // Added Validators
      description: new FormControl(productRawValue.description,[Validators.required,Validators.pattern('[a-zA-Z_-\\s]*')]), // Added Validators
